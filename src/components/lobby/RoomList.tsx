...
const MOCK_ROOMS: Room[] = [
  { id: 'room1', name: "XQc's Room", players: 12, maxPlayers: 20, status: 'waiting' },
  { id: 'room2', name: "Pokimane's Challenge", players: 18, maxPlayers: 20, status: 'playing', topPlayer: 'StreamerFan44' },
  { id: 'room3', name: "Ninja's Arena", players: 5, maxPlayers: 20, status: 'waiting' },
  { id: 'room4', name: "Shroud's Battleground", players: 20, maxPlayers: 20, status: 'playing', topPlayer: 'AimGod99' },
  { id: 'room5', name: "Ludwig's Party", players: 8, maxPlayers: 20, status: 'waiting' },
];
...
export const RoomList: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h2 className="text-2xl font-bold mb-6 text-center">Available Game Rooms</h2>
        ...
        {rooms.map((room) => (
          <div 
            ...
            className={`game-card p-4 transition-all duration-300 transform hover:scale-105 cursor-pointer ${
              room.status === 'playing' ? 'border-game-secondary/50' : 'border-game-primary/50'
            }`}
          ...
          >
            <div className="flex justify-between items-center mb-3">
              ...
              <span className={`px-2 py-1 rounded-full text-xs font-semibold ${
                room.status === 'waiting' ? 'bg-game-primary/20 text-game-primary' : 'bg-game-secondary/20 text-game-secondary'
              }`}>
