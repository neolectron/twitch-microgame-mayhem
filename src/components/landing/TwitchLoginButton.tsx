...
const TwitchLoginButton: React.FC = () => {
  ...
  const handleTwitchLogin = async () => {
    ...
    toast({
      ...
      description:
        "This feature is under development. Redirecting to lobby for preview.",
    });
...
const TwitchIcon = () => (
  ...
  >
    ...
    <path
      d="M4.5 2L2.5 6V18H7.5V22L11.5 18H14.5L21.5 11V2H4.5ZM19.5 10.2857L16.5 13.2857H13.5L10.85 15.9357V13.2857H7.5V4H19.5V10.2857Z"
      fill="white"
    />
  </svg>
);
